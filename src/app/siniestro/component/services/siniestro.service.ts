...
export class siniestroservice {
    ...
    //urltoken: string = "https://plataformadigital.stg.protectasecurity.pe/BackSiniestrosoat/api/SolSin/GetTokenSin";
    urltoken: string = "https://localhost:55764/api/SolSin/GetTokenSin";
    //urlocal: string = "https://plataformadigital.stg.protectasecurity.pe/BackSiniestrosoat/api/SiniestroSoat/getlistar";
    ...
    //url: string = "https://plataformadigital.stg.protectasecurity.pe/ApiSiniestros/api/SolSin/RegJira";
     ...
     //url: string = "https://plataformadigital.stg.protectasecurity.pe/ApiSiniestrosQA/api/SolSin/RegJira"; //servidor
