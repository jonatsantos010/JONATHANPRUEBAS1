...
export class ProSelectComponent
  ...
  /**
   * If the items array has changed, and the new array has at least one item, then set the value of the
   * select to the initial value
   * @param {SimpleChanges} changes - SimpleChanges - The changes that have been made to the input
   * properties.
   */
  ...
  /**
   * If the checkbox is checked, set the value of the label to the value of the selected options,
   * otherwise set the value of the label to an empty string.
   * @param {boolean} checked - boolean - the checked state of the checkbox
   * @param {any} item - any - this is the item that was checked/unchecked
   */
  ...
  /**
   * The function sets the value of the label and itemSelectedLabel formControls to the value of the
   * label formControl.
   * @param {any} item - any - the item selected from the list
   */
  ...
  /**
   * "If the value is not an object, then set the value to the item's value property, otherwise set the
   * value to the item's label property."
   * </code>
   * @param {any} item - any - the value of the selected item
