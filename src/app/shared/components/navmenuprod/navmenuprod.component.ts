          ...
          if (!temp) {
            ...
            r.push(
              (temp = {
                ...
                shtml:
                  nidproduct === 1 ? 'fa-car' :
                    nidproduct === 2 ? 'fa-briefcase' :
                      nidproduct === 3 ? 'fa-heart' :
                        nidproduct === 10 ? 'fa-cog' :
                          nidproduct === 6 ? 'fa-ambulance' :
                            nidproduct === 8 ? 'fa-users' :
                              nidproduct === 9 ? 'fa-money' :
                                nidproduct === 12 ? 'fa-university' :
                                  nidproduct === 4 ? 'fa-money' :
                                    nidproduct === 98 ? 'fa-list-alt' :
                                      nidproduct === 18  ? 'fa-list-alt' :
                                      	nidproduct === 97 ? 'fa-building' :
                                          nidproduct === 17 ? 'fa-money' : '',
