...
export class PanelEndosoComponent implements OnInit {
    ...
    parametersTransaction(search_type:any){
        ...
        this.transaccionProtecta = {
            P_NBRANCH: 71,
            P_NPRODUCTO: 10,
            P_NID_COTIZACION: 20468	,
            P_DEFFECDATE: '17/04/2024',
            P_DEXPIRDAT: '18/04/2025',
            P_NUSERCODE: JSON.parse(localStorage.getItem('currentUser'))['id'],
            P_NTYPE_TRANSAC: 8,
            ...
            P_POLICY: "7110000002",
            P_STRAN: 20,
            P_DSTARTDATE_ASE: '17/04/2024',
            P_DSTARTDATE_POL: '17/04/2024',
            P_DEXPIRDAT_POL: '17/04/2024',
            P_NAMO_AFEC:0,
            P_NIVA: 0,
            P_NAMOUNT: 0,
        }
