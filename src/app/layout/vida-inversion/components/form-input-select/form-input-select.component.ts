...
export class FormInputSelectComponent implements OnInit, OnChanges, OnDestroy {
  ...
  objectSinElementos: any = { codigo: '', valor: 'Ninguno', text: 'Ninguno' };
  ...
  ngOnInit() {
    ...
    //!!   PARA LA VALIDACION DE LOS PARAMETROS VAMOS ENVIARLOR POR DEFECTO UN VALOR QUE SERA "521" EL CUAL SE VA ENVIAR CUANDO NO UTILIZEMOS PARAMETROS form-input-select
