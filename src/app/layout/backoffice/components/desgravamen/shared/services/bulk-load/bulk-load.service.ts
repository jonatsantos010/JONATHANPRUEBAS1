...
export class BulkLoadService {
  ...
  getInformation(payload: { type: number; value: any }): Observable<any> {
    ...
    console.log('dato enviado a getInormation type: '+payload.type+ '- value: '+ payload.value);
 ...
 //INI <RQ2024-57 - 03/04/2024> 
  public getFacSuspendida(data: any): Observable<any> {
        
    let params = new HttpParams().set("NPOLICY",data);
    
    return this.http.get(this.url + '/AwsDesgravamen/getFacSuspendida', {headers:this.headers,params:params});
