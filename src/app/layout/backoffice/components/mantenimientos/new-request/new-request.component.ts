...
export class NewRequestComponent implements OnInit {
  ...
  getDocumentInfo(): void {
    ...
    if (
      this.formSubChannelControl['searchType'].value == this.SEARCH_TYPES.LEGALNAME
    ) {
      this.searchDocumentByNames();
      return;
    }
  ...
  selectSubChannel(): void {
    ...
    this.basicDataFormControl['legalName'].setValue(this.subChannelSelected.name);
