...
export class Step4Component
  ...
  ngOnInit(): void {
    ...
    this._AppConfig.gtmTrackEvent(gtmPage);
    ...
    this.getParameters();
    this.getPaymentType();
    this.fc['phone'].valueChanges.subscribe((val) => {
    });
    ...
    if (this.numDocExist || ndoc) {
      ...
      if (+this.resumenAtp.aseguradoInfo.aseguradoContratante == 1) {
        ...
        if (this.aseguradoValidate && this.contractorValidate && this.currentUserState == 1) {
          // this.getVisaToken();
        }
      }
