...
export class EndorseeViewComponent implements OnInit {
    ...
    async ListarCombo() {
        ...
        await this.clientInformationService.getTypeProviderList(3).subscribe(rest => {
            this.GrupoList = rest;
    ...
    async listUpInsdProvider() {
        ...
        */
        ...
        if (this.Sclient != undefined && this.Sclient != "0" && this.Sclient != 0) {
            ...
            await this.clientInformationService.updProvider(data).subscribe(rest => {
                this.GrupoList = rest
            ...
            await this.clientInformationService.insProvider(data).subscribe(rest => {
