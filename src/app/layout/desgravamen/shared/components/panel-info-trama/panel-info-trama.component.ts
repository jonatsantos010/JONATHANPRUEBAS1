...
export class PanelInfoTramaComponent implements OnInit, OnChanges {
  ...
  ngOnInit() {
    ...
    this.cotizador = this.cotizador || {};  // AGF 02052023
    this.cotizadorChange.emit(this.cotizador); // AGF 02052023
    ...
    this.ChangeHaveTrama(); // AGF 02052023
  }

  ChangeHaveTrama() {  // AGF 02052023
  ...
  validarExcel(validar?) {
    ...
    */
    ...
    console.log(this.trama.excelSubir[0]);
  ...
  validarTrama(codComission?: any) {
    ...
    this.quotationService.valTrama(myFormData).subscribe(
      (res) => {
        ...
        if (res.P_COD_ERR === '1' || res.P_COD_ERR === '2') { // AGF 02052023 agregando val. cuando se ingrese trama con Asegurado para VCF
            ...
            if (erroresList.length > 0) {
              ...
              */
              ...
              if (this.flagMensajeTrama == true) {
                this.trama.NID_PROC = res.NIDPROC; //AGF 24052023 Enviando nidproc para VCF
