...
export class QuoteComponent implements OnInit, AfterViewInit {
    @ViewChild(PanelInfoTramaComponent) data_panel: PanelInfoTramaComponent; //AGF 12052023 Beneficiarios VCF
    isAsegContra: boolean = true; //AGF 12052023 Beneficiarios VCF
    cotizacion: any = {};
    nbranch: string;
    ...
    async ngOnInit() {
        ...
        if (this.route.snapshot.data.esEvaluacion === true) {
            ...
            this.trxPendiente = CommonMethods.textFormat(this.route.snapshot.queryParams.trx);
...
*/
                console.log(genRes.EXPIRACION_ASEGURADOS);
                if (genRes.COD_ERR == 0 || genRes.COD_ERR == 2) {
                    if (genRes.COD_ERR == 2) {
                        swal.fire('Información', genRes.MENSAJE, 'info');
                    }
                    ...
                    this.cotizacion.files = genRes.RUTAS; // AGF 12052023 Beneficiarios VCF
    ...
    obtenerDatosPreCotizacion() {
        ...
        const params = {
            ...
            flagSubirTrama: this.cotizacion.trama.validado, //Valor para saber si se va enviar Trama o no al Back
            premium: 0,
            datosContratante: {
    ...
    obtenerParametrosCotizacion() {
        ...
        const params = {
            ...
            CodigoProceso: this.data_panel.trama.NID_PROC, //AGF 24052023 Envinaod cod Proceso para VCF
        ...
        if (this.modoVista == '' || this.modoVista == 'Evaluar') {
            ...
            this.policyemit.valBrokerVCF(val_data).subscribe((res) => {
                ...
                if (res.COD_ERROR == 1) {
                    ...
                    this.policyemit.getPrimasProrrat(this.cotizacion.numeroCotizacion).subscribe((res) => {
                        ...
                        this.policyemit.savePolicyEmit(myFormData).subscribe((res) => {
                            this.isLoading = false;
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    if (this.cotizacion.contratante.debtMark !== 1) {
                                        console.log(this.cotizacion.cotizador.amountPremiumListAnu);
